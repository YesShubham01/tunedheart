          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            return const Center(
              child: CircularProgressIndicator(
                value:
                    0.5, // Set the current progress value between 0.0 and 1.0
                backgroundColor:
                    Colors.grey, // Optionally, you can set a background color
                valueColor: AlwaysStoppedAnimation<Color>(
                    Colors.white), // Set the color of the progress indicator
              ...
              children: [
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      contentPadding:
                          const EdgeInsets.fromLTRB(16.0, 15.0, 8.0, 0.0),
...
//               ),
  ...
  Widget _buildSpotifyPlayer() {
    ...
    if (currentSongUrl != null) {
      displayText = extractFilenameFromUrl(currentSongUrl!);
    } else {
      displayText = "No Song Selected";
    }
          ...
          onTap: () => Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => MusicPlayer(
                ...
                filename: displayText, // Handle null case for filename
              ),
            ),
          ),
          child: currentSongUrl != null
                    ...
                    Flexible(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            displayText, // Handle null case for filename display
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 16,
                      ...
                      child: IconButton(
                        icon: Icon(
                          isPlaying
                              ? Icons.pause
                              : Icons
                                  .play_arrow, // Use updated state for play/pause icon
                          color: Colors.white,
                        ),
                        onPressed: () {
                          setState(() {
